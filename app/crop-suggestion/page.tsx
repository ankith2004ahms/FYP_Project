...
export default function CropSuggestionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('=== Frontend Crop Suggestion Debug ===');
      console.log('Sending request data:', requestData);
      
      const response = await postWithClerkAuth('/api/crop-suggestion', requestData);
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Failed to get crop suggestions');
      }
